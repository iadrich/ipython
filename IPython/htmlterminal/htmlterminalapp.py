...
_examples = """
ipython htmlterminal                       # start the htmlterminal
ipython htmlterminal --profile=sympy       # use the sympy profile
ipython htmlterminal --certfile=mycert.pem # use SSL/TLS certificate
"""
...
class HtmlTerminalWebApplication(web.Application):
    ...
    def __init__(self, ipython_app, kernel_manager, notebook_manager,
        ...
        super(HtmlTerminalWebApplication, self).__init__(handlers, **settings)
...
flags['no-browser']=(
    {'HtmlTerminalApp' : {'open_browser' : False}},
    "Don't open the notebook in a browser after startup."
)
flags['pylab']=(
    {'HtmlTerminalApp' : {'pylab' : 'warn'}},
    "DISABLED: use %pylab or %matplotlib in the notebook to enable matplotlib."
)
flags['no-mathjax']=(
    {'HtmlTerminalApp' : {'enable_mathjax' : False}},
    """Disable MathJax
...
class HtmlTerminalApp(BaseIPythonApplication):
    ...
    def parse_command_line(self, argv=None):
        super(HtmlTerminalApp, self).parse_command_line(argv)
    ...
    def init_webapp(self):
        ...
        self.web_app = HtmlTerminalWebApplication(
    ...
    def initialize(self, argv=None):
        super(HtmlTerminalApp, self).initialize(argv)
        self.init_logging()
...
launch_new_instance = HtmlTerminalApp.launch_instance
